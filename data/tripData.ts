...
export const locations: Location[] = [
  {
    ...
    places: [
      ...
      { name: "Ozone Coffee (Shoreditch)", address: "11 Leonard St, London EC2A 4AQ", category: "Food" },
      { name: "Leadenhall Market", address: "Whittington Ave, London EC3V 1LR", category: "Sights" },
      { name: "Tate Modern", address: "Bankside, London SE1 9TG", category: "Museum" },
      { name: "Borough Market", address: "8 Southwark St, London SE1 1TL", category: "Food" },
      { name: "The Red Lion (Hoxton)", address: "41 Hoxton St, London N1 6NH", category: "Food" },
      { name: "Abbey Road", address: "3 Abbey Rd, London NW8 9AY", category: "Sights" },
      { name: "Outernet London", address: "1 Charing Cross Rd, London WC2H 0DZ", category: "Sights" },
...
export const itinerary: ItineraryDay[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { id: "e_apr27_5", time: "14:20", title: "Tate Modern", location: "Bankside, SE1", type: "Museum", address: "Bankside, London SE1 9TG", bookingUrl: "https://www.tate.org.uk/visit/tate-modern", bookingLabel: "Free — Plan Visit" },
