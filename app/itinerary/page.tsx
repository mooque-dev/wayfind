  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 pt-12 pb-2">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="text-right">
            ...
            <p className="text-[12px] font-semibold text-neutral-300 mt-1">
              {day?.city ?? "—"}
            </p>
          </div>
        </div>
      ...
      <div className="px-4 pt-4 pb-2">
        {day ? (
          <>
            <p className="text-[13px] font-semibold text-neutral-500 uppercase tracking-widest">
          ...
          <p className="text-[15px] text-neutral-500">No events for this day.</p>
        )}
      </div>
      ...
      {!day && (
        <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
          ...
          <p className="text-[16px] font-semibold text-neutral-300">No events scheduled</p>
          <p className="text-[13px] text-neutral-500 mt-1">Free day — explore at your own pace</p>
        </div>
      )}
    </div>
  );
