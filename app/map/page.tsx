    ...
    <div className="min-h-screen">
      ...
      <div className="mx-4 mb-4 rounded-2xl overflow-hidden border border-white/8 bg-white/[0.03] h-48 flex flex-col items-center justify-center gap-3">
        ...
        <div className="text-center px-4">
          <p className="text-[14px] font-semibold text-fg-secondary">Interactive Map</p>
        ...
        <a
          ...
          className="flex items-center gap-1.5 text-accent text-[12px] font-medium hover:text-accent-subtle transition-colors"
        >
    ...
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-fg-muted">{location.country}</p>
        </div>
      </div>
